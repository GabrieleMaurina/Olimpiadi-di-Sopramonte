...
class MyNavigationBar(NavigationBar):
    ...
    def init_acquisition(self):
        ...
        update_athlete_page = Page(self.rightFrame, "Modifica athleti")
        register_result = Page(self.rightFrame, "Registra risultati")
        register_relay = Page(self.rightFrame, "Registra staffetta")
    ...
    def init_administration(self):
        ...
        team_creation_page = Page(self.rightFrame, "Creazione squadre")
        reset_db_page = Page(self.rightFrame, "Reset Database")
